...
# Instructions
# ==============================================================================
# Write a method called `get_largest_elment_at_property`
...
# }
#
# p get_largest_elment_at_property(apparel, :sizes) => 36
# p get_largest_elment_at_property(apparel, :msrp) => nil
# p get_largest_elment_at_property(student, :failed_courses) => nil
# p get_largest_elment_at_property(student, :scores) => 95
# p get_largest_elment_at_property(student, :name) => nil
